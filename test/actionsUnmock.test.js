...
describe('Actions', () => {
    ...
    // it('should newUser resturn the proper describe message', () => {
    //     const default_chat_id = 5434;
    //     const default_user = {
    //         id: 34_512_345,
    ...
    //     const result = Actions.newUser(default_chat_id, default_user);
    //     const expected = `Usuario registrado: Hola ${default_user.first_name} tu usuario ha sido creado.`
    //     expect(result).toBe(expected);
    // });
});